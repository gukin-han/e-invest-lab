...
1. ~~라이브 검증~~ / ~~5년 백필~~ 완료.
2. ~~PER 조회~~ 완료 — 컨센서스 응답에 최근 종가·연도별 forward PER (적자·시세 부재 시 null). 라이브 검증(2026-08-08): 현대건설 종가 112,600원 기준 2026E 23.27배 ~ 2028E 14.66배, 독립 수계산과 일치. 2024 적자 연도는 null 로 정상 생략. **market 트랙 종료.**
