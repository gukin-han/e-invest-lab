...
Offering
  ...
  segment         회사가 매출을 쪼개는 단위 (DX, 카지노, 음반/음원, WM…)
  products[]      제공물 이름들 (TV, DRAM, 신용대출, IPO 주관…) ← 검색·Concept 매핑 대상
  revenue         금액 (단위 억원/백만원/원/백만달러 혼재 → 정규화 필요)
  revenue_basis   매출액 | 수입보험료 | 영업수익 | 취급고 …
  revenue_share   비중 % (은행·단일사업은 null)
...
5. **전 회사 전수는 2a/2b 증명 후**: 역방향 쿼리가 실제 서비스될 때 폭이 가치를 가짐. 형태는 스케줄러가 아니라 1회 배치 → 연 갱신 자동화 순 (사업보고서는 연 1회, 3~4월 집중). 예외 세분화(`SourceUnavailable` vs `ContractViolation`)·부분 실패 집계도 이때 함께.
